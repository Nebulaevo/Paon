...
- [initial page props tag](/documentation/references/special-meta-tags.md#initial-page-props) : automatically added when performing SSR, can be included manually to avoid initial request at first page load.
